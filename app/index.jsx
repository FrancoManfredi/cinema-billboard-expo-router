    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.text}>
          ...
          pero ahora utilizando <Text style={styles.bold}>Expo Router</Text>{" "}
        ...
        <Text style={styles.text}>
          ...
          &ldquo;All Movies&rdquo;: Lista vertical de todas las películas{"\n"}•
          Tab &ldquo;By Categories&rdquo;: Películas agrupadas por categorías
          con scroll horizontal
        </Text>

        <Text style={styles.subtitle}>2. Pantalla de Detalles (Stack)</Text>
        <Text style={styles.text}>
          • Al hacer tap en cualquier película (desde All o By Categories),
          navegar a:{"\n"}• Pantalla{" "}
          <Text style={styles.code}>MovieDetails</Text> usando{" "}
        ...
        <Text style={styles.text}>
          ...
          las reviews en un FlatList con scroll horizontal{"\n"}• Usar{" "}
          <Text style={styles.code}>profile-circle.svgrepo-com.svg</Text> como
          imagen de perfil{"\n"}• Si no hay reviews: mostrar mensaje &ldquo;Aún
          no hay reviews para esta película&rdquo;
        </Text>
        ...
        <Text style={styles.text}>
          • Formateo de rating (estrellas ⭐){"\n"}• Formateo de duración (Xh
          Ymin){"\n"}• Fetch de datos desde json-server{"\n"}• Agregar nuevas
          películas vía API{"\n"}• Refetch automático después de agregar
